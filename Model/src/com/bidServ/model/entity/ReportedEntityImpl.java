...
// ---    Tue Nov 15 14:36:12 IST 2016
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class ReportedEntityImpl extends EntityImpl {
    /**
    ...
    public static final int REPORTID = AttributesEnum.ReportId.index();
     ...
     */
    public ReportedEntityImpl() {
    }

    /**
     * @param reportId key constituent

     * @return a Key object based on given key constituents.
     */
    public static Key createPrimaryKey(Integer reportId) {
        return new Key(new Object[] { reportId });
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("com.bidServ.model.entity.ReportedEntity");
    }
        ...
        if (i == DML_INSERT) {
            try (PreparedStatement stmt =
                ...
                try (ResultSet rs = stmt.getResultSet()) {
                    if (rs.next()) {
                        setAttribute("ReportId", Integer.valueOf(rs.getInt(1)));
                    }
                }
