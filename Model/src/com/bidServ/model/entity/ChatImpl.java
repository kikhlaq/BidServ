...
// ---    Wed Aug 03 16:02:01 IST 2016
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class ChatImpl extends EntityImpl {
    /**
    ...
    public static final int CHATTIME = AttributesEnum.ChatTime.index();
    ...
    /**
     * @param chatId key constituent

     * @return a Key object based on given key constituents.
     */
    public static Key createPrimaryKey(Integer chatId) {
        return new Key(new Object[] { chatId });
    }
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("com.bidServ.model.entity.Chat");
    }
        ...
        if (i == DML_INSERT) {
            try (PreparedStatement stmt =
                ...
                try (ResultSet rs = stmt.getResultSet()) {
                    ...
                    if (rs.next()) {
                        System.out.println("====================createComment"+BigDecimal.valueOf(rs.getLong(1)));
                        setAttribute("ChatId", Integer.valueOf(rs.getInt(1)));
                    }
                }
