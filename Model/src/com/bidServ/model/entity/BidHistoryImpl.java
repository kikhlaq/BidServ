...
// ---    Thu Nov 17 17:14:48 IST 2016
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class BidHistoryImpl extends EntityImpl {
    /**
     ...
     */
    public static Key createPrimaryKey(Integer historyId) {
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("com.bidServ.model.entity.BidHistory");
    }
        ...
        if (i == DML_INSERT) {
            try (PreparedStatement stmt =
                ...
                try (ResultSet rs = stmt.getResultSet()) {
                    if (rs.next()) {
                        setAttribute("HistoryId", Integer.valueOf(rs.getInt(1)));
                    }
                }
