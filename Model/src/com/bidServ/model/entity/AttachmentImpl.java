...
// ---    Thu Nov 17 15:00:08 IST 2016
// ---    Custom code may be added to this class.
// ---    Warning: Do not modify method signatures of generated methods.
// ---------------------------------------------------------------------
public class AttachmentImpl extends EntityImpl {
    /**
     ...
     */
    public static Key createPrimaryKey(Integer documentId) {
    ...
    public static synchronized EntityDefImpl getDefinitionObject() {
        return EntityDefImpl.findDefObject("com.bidServ.model.entity.Attachment");
    }
        ...
        if (i == DML_INSERT) {
            try (PreparedStatement stmt =
                ...
                try (ResultSet rs = stmt.getResultSet()) {
                    if (rs.next()) {
                        setAttribute("DocumentId", Integer.valueOf(rs.getInt(1)));
                    }
                }
